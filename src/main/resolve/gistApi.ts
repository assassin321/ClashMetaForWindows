...
const GIST_DESCRIPTION = 'Auto Synced Clash Meta For Windows Runtime Config'
const GIST_FILE_NAME = 'clashmetafw.yaml'
const GIST_ENCRYPTED_FILE_NAME = 'clashmetafw.yaml.age'
