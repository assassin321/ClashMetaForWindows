      ...
      submenu: [
        {
          label: '了解更多',
          click: () => {
            shell.openExternal('https://github.com/assassin321/ClashMetaForWindows')
          }
        },
        {
          label: '报告问题',
          click: () => {
            shell.openExternal('https://github.com/assassin321/ClashMetaForWindows/issues')
          }
        },
        { type: 'separator' },
        {
          ...
          click: () => {
            dialog.showMessageBox(mainWindow!, {
              type: 'info',
              title: '关于 Clash Meta For Windows',
