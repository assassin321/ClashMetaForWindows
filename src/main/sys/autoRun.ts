...
const appName = 'Clash Meta For Windows'
...
<Task version="1.2" xmlns="http://schemas.microsoft.com/windows/2004/02/mit/task">
  ...
  <Actions Context="Author">
    <Exec>
      <Command>"${escapeXml(path.join(taskDir(), `clashmetafw-run.exe`))}"</Command>
...
Type=Application
Icon=clashmetafw
StartupWMClass=clashmetafw
Comment=Clash Meta For Windows
Categories=Utility;
`
